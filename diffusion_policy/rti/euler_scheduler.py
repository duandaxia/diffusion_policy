...
class NTISchedulerOutput(BaseOutput):
    """
...
class NTIScheduler(DDPMScheduler):
    ...
    def scale_model_input(
        ...
        return DDPMScheduler.scale_model_input(self, sample, timestep)
    ...
    ) -> Union[NTISchedulerOutput, Tuple]:
        """
